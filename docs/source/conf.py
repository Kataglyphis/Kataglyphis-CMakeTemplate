...
html_theme_options = {
    "repository_url": "https://github.com/Kataglyphis/Kataglyphis-CMakeTemplate",
    "use_repository_button": True,
    "show_navbar_depth": 2,
    "navigation_with_keys": True,
}
# copy additional static assets into the built site root
# keep this list separate from Sphinx document source folders
